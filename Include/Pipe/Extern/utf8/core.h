...
// The typedefs for 8-bit, 16-bit and 32-bit code units
	...
	namespace internal
	{
		...
		{
			return (cp >= static_cast<utfchar32_t>(LEAD_SURROGATE_MIN)
			        && cp <= static_cast<utfchar32_t>(LEAD_SURROGATE_MAX));
		}

		inline bool is_trail_surrogate(utfchar32_t cp)
		{
			return (cp >= static_cast<utfchar32_t>(TRAIL_SURROGATE_MIN)
...
#define UTF8_CPP_INCREASE_AND_RETURN_ON_ERROR(IT, END) \
	{                                                  \
		...
		utf_error get_sequence_4(octet_iterator& it, octet_iterator end, utfchar32_t& code_point)
		{
			...
			code_point =
			    static_cast<utfchar32_t>(code_point + ((utf8::internal::mask8(*it) << 6) & 0xfff));
...
#undef UTF8_CPP_INCREASE_AND_RETURN_ON_ERROR
		...
		utf_error validate_next(octet_iterator& it, octet_iterator end, utfchar32_t& code_point)
		{
			...
			switch (length)
			{
				...
				case 1: err = utf8::internal::get_sequence_1(it, end, cp); break;
				case 2: err = utf8::internal::get_sequence_2(it, end, cp); break;
				case 3: err = utf8::internal::get_sequence_3(it, end, cp); break;
				case 4: err = utf8::internal::get_sequence_4(it, end, cp); break;
			}
