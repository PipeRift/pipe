...
P_OVERRIDE_TYPE_NAME(p::u8, "u8")
P_OVERRIDE_TYPE_NAME(p::i8, "i8")
P_OVERRIDE_TYPE_NAME(p::u16, "u16")
P_OVERRIDE_TYPE_NAME(p::i16, "i16")
P_OVERRIDE_TYPE_NAME(p::u32, "u32")
P_OVERRIDE_TYPE_NAME(p::i32, "i32")
P_OVERRIDE_TYPE_NAME(p::u64, "u64")
P_OVERRIDE_TYPE_NAME(p::i64, "i64")
P_OVERRIDE_TYPE_NAME(p::TChar, "TChar")
P_OVERRIDE_TYPE_NAME(p::StringView, "StringView")
P_OVERRIDE_TYPE_NAME(p::String, "String")
P_OVERRIDE_TYPE_NAME(p::Tag, "Tag")
