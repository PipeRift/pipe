...
Spec("Files.Paths", []()
{
	...
	{
#if P_PLATFORM_WINDOWS
		Expect(p::GetRelativePath("F:\\SomeFolder\\AnotherFolder"))
		    .ToEqual("SomeFolder\\AnotherFolder");
#endif
		Expect(p::GetRelativePath("/var/SomeFolder/AnotherFolder"))
		    .ToEqual("var/SomeFolder/AnotherFolder");
