...
/** Remote file systems codes */
	...
	#define P_MAGIC_CIFS 0xFF534D42
	#define P_MAGIC_CODA 0x73757245
	#define P_MAGIC_FHGFS 0x19830326
	#define P_MAGIC_FUSEBLK 0x65735546
	#define P_MAGIC_FUSECTL 0x65735543
	#define P_MAGIC_GFS 0x01161970
	#define P_MAGIC_GPFS 0x47504653
	#define P_MAGIC_KAFS 0x6B414653
	#define P_MAGIC_LUSTRE 0x0BD00BD0
	#define P_MAGIC_NCP 0x564C
	#define P_MAGIC_NFS 0x6969
	#define P_MAGIC_NFSD 0x6E667364
	#define P_MAGIC_OCFS2 0x7461636F
	#define P_MAGIC_PANFS 0xAAD7AAEA
	#define P_MAGIC_PIPEFS 0x50495045
	#define P_MAGIC_SMB 0x517B
	#define P_MAGIC_SNFS 0xBEEFDEAD
	#define P_MAGIC_VMHGFS 0xBACBACBC
	#define P_MAGIC_VXFS 0xA501FCF5
#endif
